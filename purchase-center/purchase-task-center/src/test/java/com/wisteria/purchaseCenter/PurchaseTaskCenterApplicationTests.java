...
import com.wisteria.purchaseTaskCenter.PurchaseTaskCenterApplication;
...
@SpringBootTest(classes = PurchaseTaskCenterApplication.class)
@ComponentScans(value = {
        @ComponentScan(value = "com.wisteria.*")
})
@Slf4j
class PurchaseTaskCenterApplicationTests {
    @Autowired
