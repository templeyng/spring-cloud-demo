package com.wisteria.productServerCenter.service.impl;
...
import com.wisteria.productServerCenter.mapper.SkuMapper;
...
public class SkuServiceImpl implements SkuService {
    ...
    public void loadSkuToRedis() {
        ...
        skus.forEach(e -> {
            ...
            productRedisTemplate.set(DicConstant.PRODUCT_SKU_DETAIL + e.getSkuCode(), e);
        });
    }
}
